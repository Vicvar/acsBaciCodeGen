...
public interface BaciCodeGenFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Baci Type Container</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Baci Type Container</em>'.
	 * @generated
	 */
	BaciTypeContainer createBaciTypeContainer();
