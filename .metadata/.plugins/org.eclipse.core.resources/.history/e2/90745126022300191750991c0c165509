...
public class BaciCodeGenFactoryImpl extends EFactoryImpl implements BaciCodeGenFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case BaciCodeGenPackage.CONTAINER: return createContainer();
			case BaciCodeGenPackage.BACI_TYPE_CONTAINER: return createBaciTypeContainer();
	 ...
	 * @generated
	 */
	public baciCodeGen.Container createContainer() {
	 ...
	 * @generated
	 */
	public BaciTypeContainer createBaciTypeContainer() {
		BaciTypeContainerImpl baciTypeContainer = new BaciTypeContainerImpl();
		return baciTypeContainer;
	}
