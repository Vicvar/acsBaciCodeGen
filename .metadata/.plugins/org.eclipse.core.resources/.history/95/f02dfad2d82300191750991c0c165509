...
public class ActionImpl extends MinimalEObjectImpl.Container implements Action {
	...
	protected EClass eStaticClass() {
		return BaciCodeGenPackage.Literals.ACTION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BaciCodeGenPackage.ACTION__NAME, oldName, name));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BaciCodeGenPackage.ACTION__TYPE, oldType, type));
	}
