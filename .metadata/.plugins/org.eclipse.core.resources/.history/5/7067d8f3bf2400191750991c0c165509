...
public class AttributeImpl extends MinimalEObjectImpl.Container implements Attribute {
	...
	protected EClass eStaticClass() {
		return BaciCodeGenPackage.Literals.ATTRIBUTE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BaciCodeGenPackage.ATTRIBUTE__NAME, oldName, name));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BaciCodeGenPackage.ATTRIBUTE__TYPE, oldType, type));
	}
	...
	public void setRequired(boolean newRequired) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BaciCodeGenPackage.ATTRIBUTE__REQUIRED, oldRequired, required));
	}
