...
/**
 * This is the item provider adapter for a {@link baciCodeGen.Container} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BaciCodeGenPackage.Literals.CONTAINER__NAME,
				 true,
				 false,
				 false,
	...
	protected void addLanguagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Container_language_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Container_language_feature", "_UI_Container_type"),
				 BaciCodeGenPackage.Literals.CONTAINER__LANGUAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
