 ...
 * </p>
 * <ul>
 *   <li>{@link baciCodeGen.BACIProperties.impl.ROuLongLongImpl#getAlarmFaultFamily <em>Alarm Fault Family</em>}</li>
 *   <li>{@link baciCodeGen.BACIProperties.impl.ROuLongLongImpl#getAlarmFaultMember <em>Alarm Fault Member</em>}</li>
 *   <li>{@link baciCodeGen.BACIProperties.impl.ROuLongLongImpl#getAlarmHighOff <em>Alarm High Off</em>}</li>
 *   <li>{@link baciCodeGen.BACIProperties.impl.ROuLongLongImpl#getAlarmHighOn <em>Alarm High On</em>}</li>
 *   <li>{@link baciCodeGen.BACIProperties.impl.ROuLongLongImpl#getAlarmLevel <em>Alarm Level</em>}</li>
 *   <li>{@link baciCodeGen.BACIProperties.impl.ROuLongLongImpl#getAlarmLowOff <em>Alarm Low Off</em>}</li>
 *   <li>{@link baciCodeGen.BACIProperties.impl.ROuLongLongImpl#getAlarmLowOn <em>Alarm Low On</em>}</li>
 *   <li>{@link baciCodeGen.BACIProperties.impl.ROuLongLongImpl#getAlarmTimerTrig <em>Alarm Timer Trig</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ROuLongLongImpl extends PuLongLong1Impl implements ROuLongLong {
	...
	protected EClass eStaticClass() {
		return BACIPropertiesPackage.Literals.ROU_LONG_LONG;
	}
	...
	public void setAlarmFaultFamily(String newAlarmFaultFamily) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.ROU_LONG_LONG__ALARM_FAULT_FAMILY, oldAlarmFaultFamily, alarmFaultFamily, !oldAlarmFaultFamilyESet));
	}
	...
	public void unsetAlarmFaultFamily() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.ROU_LONG_LONG__ALARM_FAULT_FAMILY, oldAlarmFaultFamily, ALARM_FAULT_FAMILY_EDEFAULT, oldAlarmFaultFamilyESet));
	}
	...
	public void setAlarmFaultMember(String newAlarmFaultMember) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.ROU_LONG_LONG__ALARM_FAULT_MEMBER, oldAlarmFaultMember, alarmFaultMember, !oldAlarmFaultMemberESet));
	}
	...
	public void unsetAlarmFaultMember() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.ROU_LONG_LONG__ALARM_FAULT_MEMBER, oldAlarmFaultMember, ALARM_FAULT_MEMBER_EDEFAULT, oldAlarmFaultMemberESet));
	}
	...
	public void setAlarmHighOff(BigInteger newAlarmHighOff) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.ROU_LONG_LONG__ALARM_HIGH_OFF, oldAlarmHighOff, alarmHighOff, !oldAlarmHighOffESet));
	}
	...
	public void unsetAlarmHighOff() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.ROU_LONG_LONG__ALARM_HIGH_OFF, oldAlarmHighOff, ALARM_HIGH_OFF_EDEFAULT, oldAlarmHighOffESet));
	}
	...
	public void setAlarmHighOn(BigInteger newAlarmHighOn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.ROU_LONG_LONG__ALARM_HIGH_ON, oldAlarmHighOn, alarmHighOn, !oldAlarmHighOnESet));
	}
	...
	public void unsetAlarmHighOn() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.ROU_LONG_LONG__ALARM_HIGH_ON, oldAlarmHighOn, ALARM_HIGH_ON_EDEFAULT, oldAlarmHighOnESet));
	}
	...
	public void setAlarmLevel(int newAlarmLevel) {
		...
		alarmLevelESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.ROU_LONG_LONG__ALARM_LEVEL, oldAlarmLevel, alarmLevel, !oldAlarmLevelESet));
	}
	...
	public void unsetAlarmLevel() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.ROU_LONG_LONG__ALARM_LEVEL, oldAlarmLevel, ALARM_LEVEL_EDEFAULT, oldAlarmLevelESet));
	}
	...
	public void setAlarmLowOff(BigInteger newAlarmLowOff) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.ROU_LONG_LONG__ALARM_LOW_OFF, oldAlarmLowOff, alarmLowOff, !oldAlarmLowOffESet));
	}
	...
	public void unsetAlarmLowOff() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.ROU_LONG_LONG__ALARM_LOW_OFF, oldAlarmLowOff, ALARM_LOW_OFF_EDEFAULT, oldAlarmLowOffESet));
	}
	...
	public void setAlarmLowOn(BigInteger newAlarmLowOn) {
		...
		alarmLowOnESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.ROU_LONG_LONG__ALARM_LOW_ON, oldAlarmLowOn, alarmLowOn, !oldAlarmLowOnESet));
	}
	...
	public void unsetAlarmLowOn() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.ROU_LONG_LONG__ALARM_LOW_ON, oldAlarmLowOn, ALARM_LOW_ON_EDEFAULT, oldAlarmLowOnESet));
	}
	...
	public void setAlarmTimerTrig(double newAlarmTimerTrig) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.ROU_LONG_LONG__ALARM_TIMER_TRIG, oldAlarmTimerTrig, alarmTimerTrig, !oldAlarmTimerTrigESet));
	}
	...
	public void unsetAlarmTimerTrig() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.ROU_LONG_LONG__ALARM_TIMER_TRIG, oldAlarmTimerTrig, ALARM_TIMER_TRIG_EDEFAULT, oldAlarmTimerTrigESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BACIPropertiesPackage.ROU_LONG_LONG__ALARM_FAULT_FAMILY:
				return getAlarmFaultFamily();
			case BACIPropertiesPackage.ROU_LONG_LONG__ALARM_FAULT_MEMBER:
				return getAlarmFaultMember();
			case BACIPropertiesPackage.ROU_LONG_LONG__ALARM_HIGH_OFF:
				return getAlarmHighOff();
			case BACIPropertiesPackage.ROU_LONG_LONG__ALARM_HIGH_ON:
				return getAlarmHighOn();
			case BACIPropertiesPackage.ROU_LONG_LONG__ALARM_LEVEL:
				return getAlarmLevel();
			case BACIPropertiesPackage.ROU_LONG_LONG__ALARM_LOW_OFF:
				return getAlarmLowOff();
			case BACIPropertiesPackage.ROU_LONG_LONG__ALARM_LOW_ON:
				return getAlarmLowOn();
			case BACIPropertiesPackage.ROU_LONG_LONG__ALARM_TIMER_TRIG:
