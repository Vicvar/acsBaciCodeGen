...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>RWboolean</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link baciCodeGen.BACIProperties.impl.RWbooleanImpl#isMaxValue <em>Max Value</em>}</li>
 *   <li>{@link baciCodeGen.BACIProperties.impl.RWbooleanImpl#isMinValue <em>Min Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RWbooleanImpl extends Pboolean1Impl implements RWboolean {
	/**
	...
	protected EClass eStaticClass() {
		return BACIPropertiesPackage.Literals.RWBOOLEAN;
	}
	...
	public void setMaxValue(boolean newMaxValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.RWBOOLEAN__MAX_VALUE, oldMaxValue, maxValue, !oldMaxValueESet));
	}
	...
	public void unsetMaxValue() {
		...
		maxValueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.RWBOOLEAN__MAX_VALUE, oldMaxValue, MAX_VALUE_EDEFAULT, oldMaxValueESet));
	}
	...
	public void setMinValue(boolean newMinValue) {
		...
		minValueESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.RWBOOLEAN__MIN_VALUE, oldMinValue, minValue, !oldMinValueESet));
	}
	...
	public void unsetMinValue() {
		...
		minValueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.RWBOOLEAN__MIN_VALUE, oldMinValue, MIN_VALUE_EDEFAULT, oldMinValueESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BACIPropertiesPackage.RWBOOLEAN__MAX_VALUE:
				return isMaxValue();
			case BACIPropertiesPackage.RWBOOLEAN__MIN_VALUE:
				return isMinValue();
		}
