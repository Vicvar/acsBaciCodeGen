 ...
 * </p>
 * <ul>
 *   <li>{@link baciCodeGen.BACIProperties.impl.ROpatternImpl#getAlarmFaultFamily <em>Alarm Fault Family</em>}</li>
 *   <li>{@link baciCodeGen.BACIProperties.impl.ROpatternImpl#getAlarmFaultMember <em>Alarm Fault Member</em>}</li>
 *   <li>{@link baciCodeGen.BACIProperties.impl.ROpatternImpl#getAlarmLevel <em>Alarm Level</em>}</li>
 *   <li>{@link baciCodeGen.BACIProperties.impl.ROpatternImpl#getAlarmMask <em>Alarm Mask</em>}</li>
 *   <li>{@link baciCodeGen.BACIProperties.impl.ROpatternImpl#getAlarmTimerTrig <em>Alarm Timer Trig</em>}</li>
 *   <li>{@link baciCodeGen.BACIProperties.impl.ROpatternImpl#getAlarmTrigger <em>Alarm Trigger</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ROpatternImpl extends Ppattern1Impl implements ROpattern {
	...
	protected EClass eStaticClass() {
		return BACIPropertiesPackage.Literals.ROPATTERN;
	}
	...
	public void setAlarmFaultFamily(String newAlarmFaultFamily) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.ROPATTERN__ALARM_FAULT_FAMILY, oldAlarmFaultFamily, alarmFaultFamily, !oldAlarmFaultFamilyESet));
	}
	...
	public void unsetAlarmFaultFamily() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.ROPATTERN__ALARM_FAULT_FAMILY, oldAlarmFaultFamily, ALARM_FAULT_FAMILY_EDEFAULT, oldAlarmFaultFamilyESet));
	}
	...
	public void setAlarmFaultMember(String newAlarmFaultMember) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.ROPATTERN__ALARM_FAULT_MEMBER, oldAlarmFaultMember, alarmFaultMember, !oldAlarmFaultMemberESet));
	}
	...
	public void unsetAlarmFaultMember() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.ROPATTERN__ALARM_FAULT_MEMBER, oldAlarmFaultMember, ALARM_FAULT_MEMBER_EDEFAULT, oldAlarmFaultMemberESet));
	}
	...
	public void setAlarmLevel(int newAlarmLevel) {
		...
		alarmLevelESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.ROPATTERN__ALARM_LEVEL, oldAlarmLevel, alarmLevel, !oldAlarmLevelESet));
	}
	...
	public void unsetAlarmLevel() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.ROPATTERN__ALARM_LEVEL, oldAlarmLevel, ALARM_LEVEL_EDEFAULT, oldAlarmLevelESet));
	}
	...
	public void setAlarmMask(BigInteger newAlarmMask) {
		...
		alarmMaskESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.ROPATTERN__ALARM_MASK, oldAlarmMask, alarmMask, !oldAlarmMaskESet));
	}
	...
	public void unsetAlarmMask() {
		...
		alarmMaskESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.ROPATTERN__ALARM_MASK, oldAlarmMask, ALARM_MASK_EDEFAULT, oldAlarmMaskESet));
	}
	...
	public void setAlarmTimerTrig(double newAlarmTimerTrig) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.ROPATTERN__ALARM_TIMER_TRIG, oldAlarmTimerTrig, alarmTimerTrig, !oldAlarmTimerTrigESet));
	}
	...
	public void unsetAlarmTimerTrig() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.ROPATTERN__ALARM_TIMER_TRIG, oldAlarmTimerTrig, ALARM_TIMER_TRIG_EDEFAULT, oldAlarmTimerTrigESet));
	}
	...
	public void setAlarmTrigger(BigInteger newAlarmTrigger) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.ROPATTERN__ALARM_TRIGGER, oldAlarmTrigger, alarmTrigger, !oldAlarmTriggerESet));
	}
	...
	public void unsetAlarmTrigger() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.ROPATTERN__ALARM_TRIGGER, oldAlarmTrigger, ALARM_TRIGGER_EDEFAULT, oldAlarmTriggerESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BACIPropertiesPackage.ROPATTERN__ALARM_FAULT_FAMILY:
				return getAlarmFaultFamily();
			case BACIPropertiesPackage.ROPATTERN__ALARM_FAULT_MEMBER:
				return getAlarmFaultMember();
			case BACIPropertiesPackage.ROPATTERN__ALARM_LEVEL:
				return getAlarmLevel();
			case BACIPropertiesPackage.ROPATTERN__ALARM_MASK:
				return getAlarmMask();
			case BACIPropertiesPackage.ROPATTERN__ALARM_TIMER_TRIG:
				return getAlarmTimerTrig();
			case BACIPropertiesPackage.ROPATTERN__ALARM_TRIGGER:
