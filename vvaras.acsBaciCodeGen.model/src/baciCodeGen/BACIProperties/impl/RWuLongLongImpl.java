 ...
 * </p>
 * <ul>
 *   <li>{@link baciCodeGen.BACIProperties.impl.RWuLongLongImpl#getMaxValue <em>Max Value</em>}</li>
 *   <li>{@link baciCodeGen.BACIProperties.impl.RWuLongLongImpl#getMinValue <em>Min Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RWuLongLongImpl extends PuLongLong1Impl implements RWuLongLong {
	...
	protected EClass eStaticClass() {
		return BACIPropertiesPackage.Literals.RWU_LONG_LONG;
	}
	...
	public void setMaxValue(BigInteger newMaxValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.RWU_LONG_LONG__MAX_VALUE, oldMaxValue, maxValue, !oldMaxValueESet));
	}
	...
	public void unsetMaxValue() {
		...
		maxValueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.RWU_LONG_LONG__MAX_VALUE, oldMaxValue, MAX_VALUE_EDEFAULT, oldMaxValueESet));
	}
	...
	public void setMinValue(BigInteger newMinValue) {
		...
		minValueESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.RWU_LONG_LONG__MIN_VALUE, oldMinValue, minValue, !oldMinValueESet));
	}
	...
	public void unsetMinValue() {
		...
		minValueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.RWU_LONG_LONG__MIN_VALUE, oldMinValue, MIN_VALUE_EDEFAULT, oldMinValueESet));
	}
