 ...
 * </p>
 * <ul>
 *   <li>{@link baciCodeGen.BACIProperties.impl.Pdouble1Impl#getArchiveDelta <em>Archive Delta</em>}</li>
 *   <li>{@link baciCodeGen.BACIProperties.impl.Pdouble1Impl#getArchiveDeltaPercent <em>Archive Delta Percent</em>}</li>
 *   <li>{@link baciCodeGen.BACIProperties.impl.Pdouble1Impl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link baciCodeGen.BACIProperties.impl.Pdouble1Impl#getGraphMax <em>Graph Max</em>}</li>
 *   <li>{@link baciCodeGen.BACIProperties.impl.Pdouble1Impl#getGraphMin <em>Graph Min</em>}</li>
 *   <li>{@link baciCodeGen.BACIProperties.impl.Pdouble1Impl#getMinDeltaTrig <em>Min Delta Trig</em>}</li>
 *   <li>{@link baciCodeGen.BACIProperties.impl.Pdouble1Impl#getMinStep <em>Min Step</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pdouble1Impl extends PdoubleImpl implements Pdouble1 {
	...
	protected EClass eStaticClass() {
		return BACIPropertiesPackage.Literals.PDOUBLE1;
	}
	...
	public void setArchiveDelta(double newArchiveDelta) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.PDOUBLE1__ARCHIVE_DELTA, oldArchiveDelta, archiveDelta, !oldArchiveDeltaESet));
	}
	...
	public void unsetArchiveDelta() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.PDOUBLE1__ARCHIVE_DELTA, oldArchiveDelta, ARCHIVE_DELTA_EDEFAULT, oldArchiveDeltaESet));
	}
	...
	public void setArchiveDeltaPercent(double newArchiveDeltaPercent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.PDOUBLE1__ARCHIVE_DELTA_PERCENT, oldArchiveDeltaPercent, archiveDeltaPercent, !oldArchiveDeltaPercentESet));
	}
	...
	public void unsetArchiveDeltaPercent() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.PDOUBLE1__ARCHIVE_DELTA_PERCENT, oldArchiveDeltaPercent, ARCHIVE_DELTA_PERCENT_EDEFAULT, oldArchiveDeltaPercentESet));
	}
	...
	public void setDefaultValue(double newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.PDOUBLE1__DEFAULT_VALUE, oldDefaultValue, defaultValue, !oldDefaultValueESet));
	}
	...
	public void unsetDefaultValue() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.PDOUBLE1__DEFAULT_VALUE, oldDefaultValue, DEFAULT_VALUE_EDEFAULT, oldDefaultValueESet));
	}
	...
	public void setGraphMax(double newGraphMax) {
		...
		graphMaxESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.PDOUBLE1__GRAPH_MAX, oldGraphMax, graphMax, !oldGraphMaxESet));
	}
	...
	public void unsetGraphMax() {
		...
		graphMaxESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.PDOUBLE1__GRAPH_MAX, oldGraphMax, GRAPH_MAX_EDEFAULT, oldGraphMaxESet));
	}
	...
	public void setGraphMin(double newGraphMin) {
		...
		graphMinESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.PDOUBLE1__GRAPH_MIN, oldGraphMin, graphMin, !oldGraphMinESet));
	}
	...
	public void unsetGraphMin() {
		...
		graphMinESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.PDOUBLE1__GRAPH_MIN, oldGraphMin, GRAPH_MIN_EDEFAULT, oldGraphMinESet));
	}
	...
	public void setMinDeltaTrig(double newMinDeltaTrig) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.PDOUBLE1__MIN_DELTA_TRIG, oldMinDeltaTrig, minDeltaTrig, !oldMinDeltaTrigESet));
	}
	...
	public void unsetMinDeltaTrig() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.PDOUBLE1__MIN_DELTA_TRIG, oldMinDeltaTrig, MIN_DELTA_TRIG_EDEFAULT, oldMinDeltaTrigESet));
	}
	...
	public void setMinStep(double newMinStep) {
		...
		minStepESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPropertiesPackage.PDOUBLE1__MIN_STEP, oldMinStep, minStep, !oldMinStepESet));
	}
	...
	public void unsetMinStep() {
		...
		minStepESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPropertiesPackage.PDOUBLE1__MIN_STEP, oldMinStep, MIN_STEP_EDEFAULT, oldMinStepESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BACIPropertiesPackage.PDOUBLE1__ARCHIVE_DELTA:
				return getArchiveDelta();
			case BACIPropertiesPackage.PDOUBLE1__ARCHIVE_DELTA_PERCENT:
				return getArchiveDeltaPercent();
			case BACIPropertiesPackage.PDOUBLE1__DEFAULT_VALUE:
				return getDefaultValue();
			case BACIPropertiesPackage.PDOUBLE1__GRAPH_MAX:
				return getGraphMax();
			case BACIPropertiesPackage.PDOUBLE1__GRAPH_MIN:
				return getGraphMin();
			case BACIPropertiesPackage.PDOUBLE1__MIN_DELTA_TRIG:
				return getMinDeltaTrig();
			case BACIPropertiesPackage.PDOUBLE1__MIN_STEP:
				return getMinStep();
		}
