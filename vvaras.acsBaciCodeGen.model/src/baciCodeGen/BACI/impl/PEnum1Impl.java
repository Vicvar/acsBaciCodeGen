 ...
 * </p>
 * <ul>
 *   <li>{@link baciCodeGen.BACI.impl.PEnum1Impl#getArchiveDelta <em>Archive Delta</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.PEnum1Impl#getArchiveDeltaPercent <em>Archive Delta Percent</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.PEnum1Impl#getCondition <em>Condition</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.PEnum1Impl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.PEnum1Impl#getGraphMax <em>Graph Max</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.PEnum1Impl#getGraphMin <em>Graph Min</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.PEnum1Impl#getStatesDescription <em>States Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PEnum1Impl extends PEnumImpl implements PEnum1 {
	...
	protected EClass eStaticClass() {
		return BACIPackage.Literals.PENUM1;
	}
	...
	public void setArchiveDelta(int newArchiveDelta) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PENUM1__ARCHIVE_DELTA, oldArchiveDelta, archiveDelta, !oldArchiveDeltaESet));
	}
	...
	public void unsetArchiveDelta() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PENUM1__ARCHIVE_DELTA, oldArchiveDelta, ARCHIVE_DELTA_EDEFAULT, oldArchiveDeltaESet));
	}
	...
	public void setArchiveDeltaPercent(double newArchiveDeltaPercent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PENUM1__ARCHIVE_DELTA_PERCENT, oldArchiveDeltaPercent, archiveDeltaPercent, !oldArchiveDeltaPercentESet));
	}
	...
	public void unsetArchiveDeltaPercent() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PENUM1__ARCHIVE_DELTA_PERCENT, oldArchiveDeltaPercent, ARCHIVE_DELTA_PERCENT_EDEFAULT, oldArchiveDeltaPercentESet));
	}
	...
	public void setCondition(String newCondition) {
		...
		conditionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PENUM1__CONDITION, oldCondition, condition, !oldConditionESet));
	}
	...
	public void unsetCondition() {
		...
		conditionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PENUM1__CONDITION, oldCondition, CONDITION_EDEFAULT, oldConditionESet));
	}
	...
	public void setDefaultValue(int newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PENUM1__DEFAULT_VALUE, oldDefaultValue, defaultValue, !oldDefaultValueESet));
	}
	...
	public void unsetDefaultValue() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PENUM1__DEFAULT_VALUE, oldDefaultValue, DEFAULT_VALUE_EDEFAULT, oldDefaultValueESet));
	}
	...
	public void setGraphMax(int newGraphMax) {
		...
		graphMaxESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PENUM1__GRAPH_MAX, oldGraphMax, graphMax, !oldGraphMaxESet));
	}
	...
	public void unsetGraphMax() {
		...
		graphMaxESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PENUM1__GRAPH_MAX, oldGraphMax, GRAPH_MAX_EDEFAULT, oldGraphMaxESet));
	}
	...
	public void setGraphMin(int newGraphMin) {
		...
		graphMinESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PENUM1__GRAPH_MIN, oldGraphMin, graphMin, !oldGraphMinESet));
	}
	...
	public void unsetGraphMin() {
		...
		graphMinESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PENUM1__GRAPH_MIN, oldGraphMin, GRAPH_MIN_EDEFAULT, oldGraphMinESet));
	}
	...
	public void setStatesDescription(String newStatesDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PENUM1__STATES_DESCRIPTION, oldStatesDescription, statesDescription, !oldStatesDescriptionESet));
	}
	...
	public void unsetStatesDescription() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PENUM1__STATES_DESCRIPTION, oldStatesDescription, STATES_DESCRIPTION_EDEFAULT, oldStatesDescriptionESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BACIPackage.PENUM1__ARCHIVE_DELTA:
				return getArchiveDelta();
			case BACIPackage.PENUM1__ARCHIVE_DELTA_PERCENT:
				return getArchiveDeltaPercent();
			case BACIPackage.PENUM1__CONDITION:
				return getCondition();
			case BACIPackage.PENUM1__DEFAULT_VALUE:
				return getDefaultValue();
			case BACIPackage.PENUM1__GRAPH_MAX:
				return getGraphMax();
			case BACIPackage.PENUM1__GRAPH_MIN:
				return getGraphMin();
			case BACIPackage.PENUM1__STATES_DESCRIPTION:
