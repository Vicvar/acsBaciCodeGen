 ...
 * </p>
 * <ul>
 *   <li>{@link baciCodeGen.BACI.impl.RWdoubleSeqImpl#getMaxValue <em>Max Value</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.RWdoubleSeqImpl#getMinValue <em>Min Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RWdoubleSeqImpl extends PdoubleSeq1Impl implements RWdoubleSeq {
	...
	protected EClass eStaticClass() {
		return BACIPackage.Literals.RWDOUBLE_SEQ;
	}
	...
	public void setMaxValue(double newMaxValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.RWDOUBLE_SEQ__MAX_VALUE, oldMaxValue, maxValue, !oldMaxValueESet));
	}
	...
	public void unsetMaxValue() {
		...
		maxValueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.RWDOUBLE_SEQ__MAX_VALUE, oldMaxValue, MAX_VALUE_EDEFAULT, oldMaxValueESet));
	}
	...
	public void setMinValue(double newMinValue) {
		...
		minValueESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.RWDOUBLE_SEQ__MIN_VALUE, oldMinValue, minValue, !oldMinValueESet));
	}
	...
	public void unsetMinValue() {
		...
		minValueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.RWDOUBLE_SEQ__MIN_VALUE, oldMinValue, MIN_VALUE_EDEFAULT, oldMinValueESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BACIPackage.RWDOUBLE_SEQ__MAX_VALUE:
				return getMaxValue();
			case BACIPackage.RWDOUBLE_SEQ__MIN_VALUE:
				return getMinValue();
		}
