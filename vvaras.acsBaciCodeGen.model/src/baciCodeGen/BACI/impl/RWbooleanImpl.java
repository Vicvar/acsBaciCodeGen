 ...
 * </p>
 * <ul>
 *   <li>{@link baciCodeGen.BACI.impl.RWbooleanImpl#isMaxValue <em>Max Value</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.RWbooleanImpl#isMinValue <em>Min Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RWbooleanImpl extends Pboolean1Impl implements RWboolean {
	...
	protected EClass eStaticClass() {
		return BACIPackage.Literals.RWBOOLEAN;
	}
	...
	public void setMaxValue(boolean newMaxValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.RWBOOLEAN__MAX_VALUE, oldMaxValue, maxValue, !oldMaxValueESet));
	}
	...
	public void unsetMaxValue() {
		...
		maxValueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.RWBOOLEAN__MAX_VALUE, oldMaxValue, MAX_VALUE_EDEFAULT, oldMaxValueESet));
	}
	...
	public void setMinValue(boolean newMinValue) {
		...
		minValueESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.RWBOOLEAN__MIN_VALUE, oldMinValue, minValue, !oldMinValueESet));
	}
	...
	public void unsetMinValue() {
		...
		minValueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.RWBOOLEAN__MIN_VALUE, oldMinValue, MIN_VALUE_EDEFAULT, oldMinValueESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BACIPackage.RWBOOLEAN__MAX_VALUE:
				return isMaxValue();
			case BACIPackage.RWBOOLEAN__MIN_VALUE:
				return isMinValue();
		}
