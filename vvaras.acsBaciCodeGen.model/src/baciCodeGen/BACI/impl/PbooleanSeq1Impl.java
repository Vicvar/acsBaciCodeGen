 ...
 * </p>
 * <ul>
 *   <li>{@link baciCodeGen.BACI.impl.PbooleanSeq1Impl#isArchiveDelta <em>Archive Delta</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.PbooleanSeq1Impl#getArchiveDeltaPercent <em>Archive Delta Percent</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.PbooleanSeq1Impl#isDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.PbooleanSeq1Impl#isGraphMax <em>Graph Max</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.PbooleanSeq1Impl#isGraphMin <em>Graph Min</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.PbooleanSeq1Impl#isMinDeltaTrig <em>Min Delta Trig</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.PbooleanSeq1Impl#isMinStep <em>Min Step</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PbooleanSeq1Impl extends PbooleanSeqImpl implements PbooleanSeq1 {
	...
	protected EClass eStaticClass() {
		return BACIPackage.Literals.PBOOLEAN_SEQ1;
	}
	...
	public void setArchiveDelta(boolean newArchiveDelta) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PBOOLEAN_SEQ1__ARCHIVE_DELTA, oldArchiveDelta, archiveDelta, !oldArchiveDeltaESet));
	}
	...
	public void unsetArchiveDelta() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PBOOLEAN_SEQ1__ARCHIVE_DELTA, oldArchiveDelta, ARCHIVE_DELTA_EDEFAULT, oldArchiveDeltaESet));
	}
	...
	public void setArchiveDeltaPercent(double newArchiveDeltaPercent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PBOOLEAN_SEQ1__ARCHIVE_DELTA_PERCENT, oldArchiveDeltaPercent, archiveDeltaPercent, !oldArchiveDeltaPercentESet));
	}
	...
	public void unsetArchiveDeltaPercent() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PBOOLEAN_SEQ1__ARCHIVE_DELTA_PERCENT, oldArchiveDeltaPercent, ARCHIVE_DELTA_PERCENT_EDEFAULT, oldArchiveDeltaPercentESet));
	}
	...
	public void setDefaultValue(boolean newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PBOOLEAN_SEQ1__DEFAULT_VALUE, oldDefaultValue, defaultValue, !oldDefaultValueESet));
	}
	...
	public void unsetDefaultValue() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PBOOLEAN_SEQ1__DEFAULT_VALUE, oldDefaultValue, DEFAULT_VALUE_EDEFAULT, oldDefaultValueESet));
	}
	...
	public void setGraphMax(boolean newGraphMax) {
		...
		graphMaxESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PBOOLEAN_SEQ1__GRAPH_MAX, oldGraphMax, graphMax, !oldGraphMaxESet));
	}
	...
	public void unsetGraphMax() {
		...
		graphMaxESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PBOOLEAN_SEQ1__GRAPH_MAX, oldGraphMax, GRAPH_MAX_EDEFAULT, oldGraphMaxESet));
	}
	...
	public void setGraphMin(boolean newGraphMin) {
		...
		graphMinESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PBOOLEAN_SEQ1__GRAPH_MIN, oldGraphMin, graphMin, !oldGraphMinESet));
	}
	...
	public void unsetGraphMin() {
		...
		graphMinESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PBOOLEAN_SEQ1__GRAPH_MIN, oldGraphMin, GRAPH_MIN_EDEFAULT, oldGraphMinESet));
	}
	...
	public void setMinDeltaTrig(boolean newMinDeltaTrig) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PBOOLEAN_SEQ1__MIN_DELTA_TRIG, oldMinDeltaTrig, minDeltaTrig, !oldMinDeltaTrigESet));
	}
	...
	public void unsetMinDeltaTrig() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PBOOLEAN_SEQ1__MIN_DELTA_TRIG, oldMinDeltaTrig, MIN_DELTA_TRIG_EDEFAULT, oldMinDeltaTrigESet));
	}
	...
	public void setMinStep(boolean newMinStep) {
		...
		minStepESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PBOOLEAN_SEQ1__MIN_STEP, oldMinStep, minStep, !oldMinStepESet));
	}
	...
	public void unsetMinStep() {
		...
		minStepESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PBOOLEAN_SEQ1__MIN_STEP, oldMinStep, MIN_STEP_EDEFAULT, oldMinStepESet));
	}
