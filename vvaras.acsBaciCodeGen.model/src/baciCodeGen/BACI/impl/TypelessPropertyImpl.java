...
import baciCodeGen.BACI.TypelessProperty;
 ...
 * </p>
 * <ul>
 *   <li>{@link baciCodeGen.BACI.impl.TypelessPropertyImpl#getArchiveMaxInt <em>Archive Max Int</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.TypelessPropertyImpl#getArchiveMechanism <em>Archive Mechanism</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.TypelessPropertyImpl#getArchiveMinInt <em>Archive Min Int</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.TypelessPropertyImpl#getArchivePriority <em>Archive Priority</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.TypelessPropertyImpl#isArchiveSuppress <em>Archive Suppress</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.TypelessPropertyImpl#getDefaultTimerTrig <em>Default Timer Trig</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.TypelessPropertyImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.TypelessPropertyImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.TypelessPropertyImpl#isInitializeDevio <em>Initialize Devio</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.TypelessPropertyImpl#getMinTimerTrig <em>Min Timer Trig</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.TypelessPropertyImpl#getResolution <em>Resolution</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.TypelessPropertyImpl#getUnits <em>Units</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypelessPropertyImpl extends PropertyImpl implements TypelessProperty {
	...
	protected EClass eStaticClass() {
		return BACIPackage.Literals.TYPELESS_PROPERTY;
	}
	...
	public void setArchiveMaxInt(double newArchiveMaxInt) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.TYPELESS_PROPERTY__ARCHIVE_MAX_INT, oldArchiveMaxInt, archiveMaxInt, !oldArchiveMaxIntESet));
	}
	...
	public void unsetArchiveMaxInt() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.TYPELESS_PROPERTY__ARCHIVE_MAX_INT, oldArchiveMaxInt, ARCHIVE_MAX_INT_EDEFAULT, oldArchiveMaxIntESet));
	}
	...
	public void setArchiveMechanism(String newArchiveMechanism) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.TYPELESS_PROPERTY__ARCHIVE_MECHANISM, oldArchiveMechanism, archiveMechanism, !oldArchiveMechanismESet));
	}
	...
	public void unsetArchiveMechanism() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.TYPELESS_PROPERTY__ARCHIVE_MECHANISM, oldArchiveMechanism, ARCHIVE_MECHANISM_EDEFAULT, oldArchiveMechanismESet));
	}
	...
	public void setArchiveMinInt(double newArchiveMinInt) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.TYPELESS_PROPERTY__ARCHIVE_MIN_INT, oldArchiveMinInt, archiveMinInt, !oldArchiveMinIntESet));
	}
	...
	public void unsetArchiveMinInt() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.TYPELESS_PROPERTY__ARCHIVE_MIN_INT, oldArchiveMinInt, ARCHIVE_MIN_INT_EDEFAULT, oldArchiveMinIntESet));
	}
	...
	public void setArchivePriority(int newArchivePriority) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.TYPELESS_PROPERTY__ARCHIVE_PRIORITY, oldArchivePriority, archivePriority, !oldArchivePriorityESet));
	}
	...
	public void unsetArchivePriority() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.TYPELESS_PROPERTY__ARCHIVE_PRIORITY, oldArchivePriority, ARCHIVE_PRIORITY_EDEFAULT, oldArchivePriorityESet));
	}
	...
	public void setArchiveSuppress(boolean newArchiveSuppress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.TYPELESS_PROPERTY__ARCHIVE_SUPPRESS, oldArchiveSuppress, archiveSuppress, !oldArchiveSuppressESet));
	}
	...
	public void unsetArchiveSuppress() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.TYPELESS_PROPERTY__ARCHIVE_SUPPRESS, oldArchiveSuppress, ARCHIVE_SUPPRESS_EDEFAULT, oldArchiveSuppressESet));
	}
	...
	public void setDefaultTimerTrig(double newDefaultTimerTrig) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.TYPELESS_PROPERTY__DEFAULT_TIMER_TRIG, oldDefaultTimerTrig, defaultTimerTrig, !oldDefaultTimerTrigESet));
	}
	...
	public void unsetDefaultTimerTrig() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.TYPELESS_PROPERTY__DEFAULT_TIMER_TRIG, oldDefaultTimerTrig, DEFAULT_TIMER_TRIG_EDEFAULT, oldDefaultTimerTrigESet));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.TYPELESS_PROPERTY__DESCRIPTION, oldDescription, description, !oldDescriptionESet));
	}
	...
	public void unsetDescription() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.TYPELESS_PROPERTY__DESCRIPTION, oldDescription, DESCRIPTION_EDEFAULT, oldDescriptionESet));
	}
	...
	public void setFormat(String newFormat) {
		...
		formatESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.TYPELESS_PROPERTY__FORMAT, oldFormat, format, !oldFormatESet));
	}
	...
	public void unsetFormat() {
		...
		formatESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.TYPELESS_PROPERTY__FORMAT, oldFormat, FORMAT_EDEFAULT, oldFormatESet));
	}
	...
	public void setInitializeDevio(boolean newInitializeDevio) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.TYPELESS_PROPERTY__INITIALIZE_DEVIO, oldInitializeDevio, initializeDevio, !oldInitializeDevioESet));
	}
	...
	public void unsetInitializeDevio() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.TYPELESS_PROPERTY__INITIALIZE_DEVIO, oldInitializeDevio, INITIALIZE_DEVIO_EDEFAULT, oldInitializeDevioESet));
	}
	...
	public void setMinTimerTrig(double newMinTimerTrig) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.TYPELESS_PROPERTY__MIN_TIMER_TRIG, oldMinTimerTrig, minTimerTrig, !oldMinTimerTrigESet));
	}
	...
	public void unsetMinTimerTrig() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.TYPELESS_PROPERTY__MIN_TIMER_TRIG, oldMinTimerTrig, MIN_TIMER_TRIG_EDEFAULT, oldMinTimerTrigESet));
	}
	...
	public void setResolution(BigInteger newResolution) {
		...
		resolutionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.TYPELESS_PROPERTY__RESOLUTION, oldResolution, resolution, !oldResolutionESet));
	}
	...
	public void unsetResolution() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.TYPELESS_PROPERTY__RESOLUTION, oldResolution, RESOLUTION_EDEFAULT, oldResolutionESet));
	}
	...
	public void setUnits(String newUnits) {
		...
		unitsESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.TYPELESS_PROPERTY__UNITS, oldUnits, units, !oldUnitsESet));
	}
	...
	public void unsetUnits() {
		...
		unitsESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.TYPELESS_PROPERTY__UNITS, oldUnits, UNITS_EDEFAULT, oldUnitsESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BACIPackage.TYPELESS_PROPERTY__ARCHIVE_MAX_INT:
				return getArchiveMaxInt();
			case BACIPackage.TYPELESS_PROPERTY__ARCHIVE_MECHANISM:
				return getArchiveMechanism();
			case BACIPackage.TYPELESS_PROPERTY__ARCHIVE_MIN_INT:
				return getArchiveMinInt();
			case BACIPackage.TYPELESS_PROPERTY__ARCHIVE_PRIORITY:
				return getArchivePriority();
			case BACIPackage.TYPELESS_PROPERTY__ARCHIVE_SUPPRESS:
				return isArchiveSuppress();
			case BACIPackage.TYPELESS_PROPERTY__DEFAULT_TIMER_TRIG:
				return getDefaultTimerTrig();
			case BACIPackage.TYPELESS_PROPERTY__DESCRIPTION:
				return getDescription();
			case BACIPackage.TYPELESS_PROPERTY__FORMAT:
				return getFormat();
			case BACIPackage.TYPELESS_PROPERTY__INITIALIZE_DEVIO:
				return isInitializeDevio();
			case BACIPackage.TYPELESS_PROPERTY__MIN_TIMER_TRIG:
				return getMinTimerTrig();
			case BACIPackage.TYPELESS_PROPERTY__RESOLUTION:
				return getResolution();
			case BACIPackage.TYPELESS_PROPERTY__UNITS:
				return getUnits();
		}
