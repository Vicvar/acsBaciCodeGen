 ...
 * </p>
 * <ul>
 *   <li>{@link baciCodeGen.BACI.impl.CharacteristicComponentImpl#getActionThreadStackSize <em>Action Thread Stack Size</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.CharacteristicComponentImpl#getMonitoringThreadStackSize <em>Monitoring Thread Stack Size</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.CharacteristicComponentImpl#getRecentCommand <em>Recent Command</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.CharacteristicComponentImpl#getRecentTimeStamp <em>Recent Time Stamp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CharacteristicComponentImpl extends CharacteristicModelImpl implements CharacteristicComponent {
	...
	protected EClass eStaticClass() {
		return BACIPackage.Literals.CHARACTERISTIC_COMPONENT;
	}
	...
	public void setActionThreadStackSize(BigInteger newActionThreadStackSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.CHARACTERISTIC_COMPONENT__ACTION_THREAD_STACK_SIZE, oldActionThreadStackSize, actionThreadStackSize, !oldActionThreadStackSizeESet));
	}
	...
	public void unsetActionThreadStackSize() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.CHARACTERISTIC_COMPONENT__ACTION_THREAD_STACK_SIZE, oldActionThreadStackSize, ACTION_THREAD_STACK_SIZE_EDEFAULT, oldActionThreadStackSizeESet));
	}
	...
	public void setMonitoringThreadStackSize(BigInteger newMonitoringThreadStackSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.CHARACTERISTIC_COMPONENT__MONITORING_THREAD_STACK_SIZE, oldMonitoringThreadStackSize, monitoringThreadStackSize, !oldMonitoringThreadStackSizeESet));
	}
	...
	public void unsetMonitoringThreadStackSize() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.CHARACTERISTIC_COMPONENT__MONITORING_THREAD_STACK_SIZE, oldMonitoringThreadStackSize, MONITORING_THREAD_STACK_SIZE_EDEFAULT, oldMonitoringThreadStackSizeESet));
	}
	...
	public void setRecentCommand(String newRecentCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.CHARACTERISTIC_COMPONENT__RECENT_COMMAND, oldRecentCommand, recentCommand, !oldRecentCommandESet));
	}
	...
	public void unsetRecentCommand() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.CHARACTERISTIC_COMPONENT__RECENT_COMMAND, oldRecentCommand, RECENT_COMMAND_EDEFAULT, oldRecentCommandESet));
	}
	...
	public void setRecentTimeStamp(String newRecentTimeStamp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.CHARACTERISTIC_COMPONENT__RECENT_TIME_STAMP, oldRecentTimeStamp, recentTimeStamp, !oldRecentTimeStampESet));
	}
	...
	public void unsetRecentTimeStamp() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.CHARACTERISTIC_COMPONENT__RECENT_TIME_STAMP, oldRecentTimeStamp, RECENT_TIME_STAMP_EDEFAULT, oldRecentTimeStampESet));
	}
