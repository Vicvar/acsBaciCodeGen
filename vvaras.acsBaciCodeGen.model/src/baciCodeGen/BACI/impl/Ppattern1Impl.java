 ...
 * </p>
 * <ul>
 *   <li>{@link baciCodeGen.BACI.impl.Ppattern1Impl#getArchiveDelta <em>Archive Delta</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.Ppattern1Impl#getArchiveDeltaPercent <em>Archive Delta Percent</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.Ppattern1Impl#getBitDescription <em>Bit Description</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.Ppattern1Impl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.Ppattern1Impl#getMinStep <em>Min Step</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.Ppattern1Impl#getWhenCleared <em>When Cleared</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.Ppattern1Impl#getWhenSet <em>When Set</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Ppattern1Impl extends PpatternImpl implements Ppattern1 {
	...
	protected EClass eStaticClass() {
		return BACIPackage.Literals.PPATTERN1;
	}
	...
	public void setArchiveDelta(BigInteger newArchiveDelta) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PPATTERN1__ARCHIVE_DELTA, oldArchiveDelta, archiveDelta, !oldArchiveDeltaESet));
	}
	...
	public void unsetArchiveDelta() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PPATTERN1__ARCHIVE_DELTA, oldArchiveDelta, ARCHIVE_DELTA_EDEFAULT, oldArchiveDeltaESet));
	}
	...
	public void setArchiveDeltaPercent(double newArchiveDeltaPercent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PPATTERN1__ARCHIVE_DELTA_PERCENT, oldArchiveDeltaPercent, archiveDeltaPercent, !oldArchiveDeltaPercentESet));
	}
	...
	public void unsetArchiveDeltaPercent() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PPATTERN1__ARCHIVE_DELTA_PERCENT, oldArchiveDeltaPercent, ARCHIVE_DELTA_PERCENT_EDEFAULT, oldArchiveDeltaPercentESet));
	}
	...
	public void setBitDescription(String newBitDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PPATTERN1__BIT_DESCRIPTION, oldBitDescription, bitDescription, !oldBitDescriptionESet));
	}
	...
	public void unsetBitDescription() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PPATTERN1__BIT_DESCRIPTION, oldBitDescription, BIT_DESCRIPTION_EDEFAULT, oldBitDescriptionESet));
	}
	...
	public void setDefaultValue(BigInteger newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PPATTERN1__DEFAULT_VALUE, oldDefaultValue, defaultValue, !oldDefaultValueESet));
	}
	...
	public void unsetDefaultValue() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PPATTERN1__DEFAULT_VALUE, oldDefaultValue, DEFAULT_VALUE_EDEFAULT, oldDefaultValueESet));
	}
	...
	public void setMinStep(BigInteger newMinStep) {
		...
		minStepESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PPATTERN1__MIN_STEP, oldMinStep, minStep, !oldMinStepESet));
	}
	...
	public void unsetMinStep() {
		...
		minStepESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PPATTERN1__MIN_STEP, oldMinStep, MIN_STEP_EDEFAULT, oldMinStepESet));
	}
	...
	public void setWhenCleared(String newWhenCleared) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PPATTERN1__WHEN_CLEARED, oldWhenCleared, whenCleared, !oldWhenClearedESet));
	}
	...
	public void unsetWhenCleared() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PPATTERN1__WHEN_CLEARED, oldWhenCleared, WHEN_CLEARED_EDEFAULT, oldWhenClearedESet));
	}
	...
	public void setWhenSet(String newWhenSet) {
		...
		whenSetESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PPATTERN1__WHEN_SET, oldWhenSet, whenSet, !oldWhenSetESet));
	}
	...
	public void unsetWhenSet() {
		...
		whenSetESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PPATTERN1__WHEN_SET, oldWhenSet, WHEN_SET_EDEFAULT, oldWhenSetESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BACIPackage.PPATTERN1__ARCHIVE_DELTA:
				return getArchiveDelta();
			case BACIPackage.PPATTERN1__ARCHIVE_DELTA_PERCENT:
				return getArchiveDeltaPercent();
			case BACIPackage.PPATTERN1__BIT_DESCRIPTION:
				return getBitDescription();
			case BACIPackage.PPATTERN1__DEFAULT_VALUE:
				return getDefaultValue();
			case BACIPackage.PPATTERN1__MIN_STEP:
				return getMinStep();
			case BACIPackage.PPATTERN1__WHEN_CLEARED:
				return getWhenCleared();
			case BACIPackage.PPATTERN1__WHEN_SET:
				return getWhenSet();
		}
