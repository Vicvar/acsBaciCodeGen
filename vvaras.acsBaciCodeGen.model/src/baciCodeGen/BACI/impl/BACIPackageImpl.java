...
import baciCodeGen.BACI.CharacteristicModel;
import baciCodeGen.BACI.PEnum;
import baciCodeGen.BACI.PEnum1;
import baciCodeGen.BACI.Pboolean;
import baciCodeGen.BACI.Pboolean1;
import baciCodeGen.BACI.PbooleanSeq;
import baciCodeGen.BACI.PbooleanSeq1;
import baciCodeGen.BACI.Pdouble;
import baciCodeGen.BACI.Pdouble1;
import baciCodeGen.BACI.PdoubleSeq;
import baciCodeGen.BACI.PdoubleSeq1;
import baciCodeGen.BACI.Pfloat;
import baciCodeGen.BACI.Pfloat1;
...
import baciCodeGen.BACI.PlongLong;
import baciCodeGen.BACI.PlongLong1;
import baciCodeGen.BACI.PlongSeq;
import baciCodeGen.BACI.PlongSeq1;
import baciCodeGen.BACI.Ppattern;
import baciCodeGen.BACI.Ppattern1;
import baciCodeGen.BACI.Property;
import baciCodeGen.BACI.Pstring;
import baciCodeGen.BACI.Pstring1;
import baciCodeGen.BACI.PstringSeq;
import baciCodeGen.BACI.PstringSeq1;
import baciCodeGen.BACI.PuLong;
import baciCodeGen.BACI.PuLong1;
import baciCodeGen.BACI.PuLongLong;
import baciCodeGen.BACI.PuLongLong1;
import baciCodeGen.BACI.PuLongSeq;
import baciCodeGen.BACI.PuLongSeq1;
import baciCodeGen.BACI.ROEnum;
import baciCodeGen.BACI.ROboolean;
import baciCodeGen.BACI.RObooleanSeq;
import baciCodeGen.BACI.ROdouble;
...
import baciCodeGen.BACI.RWdoubleSeq;
import baciCodeGen.BACI.RWfloat;
import baciCodeGen.BACI.RWfloatSeq;
import baciCodeGen.BACI.RWlong;
import baciCodeGen.BACI.RWlongLong;
import baciCodeGen.BACI.RWlongSeq;
import baciCodeGen.BACI.RWpattern;
import baciCodeGen.BACI.RWstring;
import baciCodeGen.BACI.RWuLong;
 ...
 * @generated
 */
public class BACIPackageImpl extends EPackageImpl implements BACIPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see baciCodeGen.BACI.BACIPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private BACIPackageImpl() {
		super(eNS_URI, BACIFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link BACIPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static BACIPackage init() {
		if (isInited) return (BACIPackage)EPackage.Registry.INSTANCE.getEPackage(BACIPackage.eNS_URI);

		// Obtain or create and register package
		BACIPackageImpl theBACIPackage = (BACIPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof BACIPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new BACIPackageImpl());
		...
		theBACIPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(BACIPackage.eNS_URI, theBACIPackage);
		return theBACIPackage;
	}
	 ...
	 * @generated
	 */
	public BACIFactory getBACIFactory() {
		return (BACIFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		rObooleanEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rObooleanSeqEClass.getESuperTypes().add(this.getPbooleanSeq1());
		rObooleanSeqEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rOdoubleEClass.getESuperTypes().add(this.getPdouble1());
		rOdoubleEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rOdoubleSeqEClass.getESuperTypes().add(this.getPdoubleSeq1());
		rOdoubleSeqEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		roEnumEClass.getESuperTypes().add(this.getPEnum1());
		rOfloatEClass.getESuperTypes().add(this.getPfloat1());
		rOfloatEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rOfloatSeqEClass.getESuperTypes().add(this.getPfloatSeq1());
		rOfloatSeqEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rOlongEClass.getESuperTypes().add(this.getPlong1());
		rOlongEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rOlongLongEClass.getESuperTypes().add(this.getPlongLong1());
		rOlongLongEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rOlongSeqEClass.getESuperTypes().add(this.getPlongSeq1());
		rOlongSeqEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rOpatternEClass.getESuperTypes().add(this.getPpattern1());
		rOpatternEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rOstringEClass.getESuperTypes().add(this.getPstring1());
		rOstringEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rOstringSeqEClass.getESuperTypes().add(this.getPstringSeq1());
		rOstringSeqEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rOuLongEClass.getESuperTypes().add(this.getPuLong1());
		rOuLongEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rOuLongLongEClass.getESuperTypes().add(this.getPuLongLong1());
		rOuLongLongEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rOuLongSeqEClass.getESuperTypes().add(this.getPuLongSeq1());
		rOuLongSeqEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rWbooleanEClass.getESuperTypes().add(this.getPboolean1());
		rWbooleanEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rWbooleanSeqEClass.getESuperTypes().add(this.getPbooleanSeq1());
		rWbooleanSeqEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rWdoubleEClass.getESuperTypes().add(this.getPdouble1());
		rWdoubleEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rWdoubleSeqEClass.getESuperTypes().add(this.getPdoubleSeq1());
		rWdoubleSeqEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rwEnumEClass.getESuperTypes().add(this.getPEnum1());
		rWfloatEClass.getESuperTypes().add(this.getPfloat1());
		rWfloatEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rWfloatSeqEClass.getESuperTypes().add(this.getPfloatSeq1());
		rWfloatSeqEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rWlongEClass.getESuperTypes().add(this.getPlong1());
		rWlongEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rWlongLongEClass.getESuperTypes().add(this.getPlongLong1());
		rWlongLongEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rWlongSeqEClass.getESuperTypes().add(this.getPlongSeq1());
		rWlongSeqEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rWpatternEClass.getESuperTypes().add(this.getPpattern1());
		rWpatternEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rWstringEClass.getESuperTypes().add(this.getPstring1());
		rWstringEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rWuLongEClass.getESuperTypes().add(this.getPuLong1());
		rWuLongEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rWuLongLongEClass.getESuperTypes().add(this.getPuLongLong1());
		rWuLongLongEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
		rWuLongSeqEClass.getESuperTypes().add(this.getPuLongSeq1());
		rWuLongSeqEClass.getESuperTypes().add(theBaciCodeGenPackage.getBaciCharacteristics());
