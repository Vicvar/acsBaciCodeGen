...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>ROboolean Seq</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link baciCodeGen.BACI.impl.RObooleanSeqImpl#getAlarmFaultFamily <em>Alarm Fault Family</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.RObooleanSeqImpl#getAlarmFaultMember <em>Alarm Fault Member</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.RObooleanSeqImpl#getAlarmLevel <em>Alarm Level</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.RObooleanSeqImpl#isAlarmOn <em>Alarm On</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.RObooleanSeqImpl#getAlarmTimerTrig <em>Alarm Timer Trig</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RObooleanSeqImpl extends PbooleanSeq1Impl implements RObooleanSeq {
	/**
	...
	protected EClass eStaticClass() {
		return BACIPackage.Literals.ROBOOLEAN_SEQ;
	}
	...
	public void setAlarmFaultFamily(String newAlarmFaultFamily) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.ROBOOLEAN_SEQ__ALARM_FAULT_FAMILY, oldAlarmFaultFamily, alarmFaultFamily, !oldAlarmFaultFamilyESet));
	}
	...
	public void unsetAlarmFaultFamily() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.ROBOOLEAN_SEQ__ALARM_FAULT_FAMILY, oldAlarmFaultFamily, ALARM_FAULT_FAMILY_EDEFAULT, oldAlarmFaultFamilyESet));
	}
	...
	public void setAlarmFaultMember(String newAlarmFaultMember) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.ROBOOLEAN_SEQ__ALARM_FAULT_MEMBER, oldAlarmFaultMember, alarmFaultMember, !oldAlarmFaultMemberESet));
	}
	...
	public void unsetAlarmFaultMember() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.ROBOOLEAN_SEQ__ALARM_FAULT_MEMBER, oldAlarmFaultMember, ALARM_FAULT_MEMBER_EDEFAULT, oldAlarmFaultMemberESet));
	}
	...
	public void setAlarmLevel(int newAlarmLevel) {
		...
		alarmLevelESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.ROBOOLEAN_SEQ__ALARM_LEVEL, oldAlarmLevel, alarmLevel, !oldAlarmLevelESet));
	}
	...
	public void unsetAlarmLevel() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.ROBOOLEAN_SEQ__ALARM_LEVEL, oldAlarmLevel, ALARM_LEVEL_EDEFAULT, oldAlarmLevelESet));
	}
	...
	public void setAlarmOn(boolean newAlarmOn) {
		...
		alarmOnESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.ROBOOLEAN_SEQ__ALARM_ON, oldAlarmOn, alarmOn, !oldAlarmOnESet));
	}
	...
	public void unsetAlarmOn() {
		...
		alarmOnESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.ROBOOLEAN_SEQ__ALARM_ON, oldAlarmOn, ALARM_ON_EDEFAULT, oldAlarmOnESet));
	}
	...
	public void setAlarmTimerTrig(double newAlarmTimerTrig) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.ROBOOLEAN_SEQ__ALARM_TIMER_TRIG, oldAlarmTimerTrig, alarmTimerTrig, !oldAlarmTimerTrigESet));
	}
	...
	public void unsetAlarmTimerTrig() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.ROBOOLEAN_SEQ__ALARM_TIMER_TRIG, oldAlarmTimerTrig, ALARM_TIMER_TRIG_EDEFAULT, oldAlarmTimerTrigESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BACIPackage.ROBOOLEAN_SEQ__ALARM_FAULT_FAMILY:
				return getAlarmFaultFamily();
			case BACIPackage.ROBOOLEAN_SEQ__ALARM_FAULT_MEMBER:
				return getAlarmFaultMember();
			case BACIPackage.ROBOOLEAN_SEQ__ALARM_LEVEL:
				return getAlarmLevel();
			case BACIPackage.ROBOOLEAN_SEQ__ALARM_ON:
				return isAlarmOn();
			case BACIPackage.ROBOOLEAN_SEQ__ALARM_TIMER_TRIG:
