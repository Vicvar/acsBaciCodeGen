 ...
 * </p>
 * <ul>
 *   <li>{@link baciCodeGen.BACI.impl.RWEnumImpl#getMaxValue <em>Max Value</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.RWEnumImpl#getMinValue <em>Min Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RWEnumImpl extends PEnum1Impl implements RWEnum {
	...
	protected EClass eStaticClass() {
		return BACIPackage.Literals.RW_ENUM;
	}
	...
	public void setMaxValue(int newMaxValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.RW_ENUM__MAX_VALUE, oldMaxValue, maxValue, !oldMaxValueESet));
	}
	...
	public void unsetMaxValue() {
		...
		maxValueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.RW_ENUM__MAX_VALUE, oldMaxValue, MAX_VALUE_EDEFAULT, oldMaxValueESet));
	}
	...
	public void setMinValue(int newMinValue) {
		...
		minValueESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.RW_ENUM__MIN_VALUE, oldMinValue, minValue, !oldMinValueESet));
	}
	...
	public void unsetMinValue() {
		...
		minValueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.RW_ENUM__MIN_VALUE, oldMinValue, MIN_VALUE_EDEFAULT, oldMinValueESet));
	}
