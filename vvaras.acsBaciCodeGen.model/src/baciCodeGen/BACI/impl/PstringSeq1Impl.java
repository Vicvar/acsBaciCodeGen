 ...
 * </p>
 * <ul>
 *   <li>{@link baciCodeGen.BACI.impl.PstringSeq1Impl#getArchiveDelta <em>Archive Delta</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.PstringSeq1Impl#getArchiveDeltaPercent <em>Archive Delta Percent</em>}</li>
 *   <li>{@link baciCodeGen.BACI.impl.PstringSeq1Impl#getDefaultValue <em>Default Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PstringSeq1Impl extends PstringSeqImpl implements PstringSeq1 {
	...
	protected EClass eStaticClass() {
		return BACIPackage.Literals.PSTRING_SEQ1;
	}
	...
	public void setArchiveDelta(String newArchiveDelta) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PSTRING_SEQ1__ARCHIVE_DELTA, oldArchiveDelta, archiveDelta, !oldArchiveDeltaESet));
	}
	...
	public void unsetArchiveDelta() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PSTRING_SEQ1__ARCHIVE_DELTA, oldArchiveDelta, ARCHIVE_DELTA_EDEFAULT, oldArchiveDeltaESet));
	}
	...
	public void setArchiveDeltaPercent(double newArchiveDeltaPercent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PSTRING_SEQ1__ARCHIVE_DELTA_PERCENT, oldArchiveDeltaPercent, archiveDeltaPercent, !oldArchiveDeltaPercentESet));
	}
	...
	public void unsetArchiveDeltaPercent() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PSTRING_SEQ1__ARCHIVE_DELTA_PERCENT, oldArchiveDeltaPercent, ARCHIVE_DELTA_PERCENT_EDEFAULT, oldArchiveDeltaPercentESet));
	}
	...
	public void setDefaultValue(String newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BACIPackage.PSTRING_SEQ1__DEFAULT_VALUE, oldDefaultValue, defaultValue, !oldDefaultValueESet));
	}
	...
	public void unsetDefaultValue() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BACIPackage.PSTRING_SEQ1__DEFAULT_VALUE, oldDefaultValue, DEFAULT_VALUE_EDEFAULT, oldDefaultValueESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BACIPackage.PSTRING_SEQ1__ARCHIVE_DELTA:
				return getArchiveDelta();
			case BACIPackage.PSTRING_SEQ1__ARCHIVE_DELTA_PERCENT:
				return getArchiveDeltaPercent();
			case BACIPackage.PSTRING_SEQ1__DEFAULT_VALUE:
