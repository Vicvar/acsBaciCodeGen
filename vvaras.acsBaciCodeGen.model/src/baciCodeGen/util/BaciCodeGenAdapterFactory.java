...
public class BaciCodeGenAdapterFactory extends AdapterFactoryImpl {
	...
	protected BaciCodeGenSwitch<Adapter> modelSwitch =
		new BaciCodeGenSwitch<Adapter>() {
			...
			@Override
			public Adapter caseBaciTypeContainer(BaciTypeContainer object) {
				return createBaciTypeContainerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link baciCodeGen.BaciTypeContainer <em>Baci Type Container</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
